{
    ...
    string gammaTimeCorrectionName = "gammaOffsetByGammaNumber";

    file->cd("summedDet");

    TH2D* gammaTimeCorrection = (TH2D*)gDirectory->Get(gammaTimeCorrectionName.c_str());
