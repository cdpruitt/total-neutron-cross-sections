void relativeCS_124To112()
{
    ...
    string graphName = "relDiff124112_sd10_x100";
    TGraphErrors* graph = (TGraphErrors*)graphFile->Get(graphName.c_str());

    string correctedGraphFileName = "/data2/analysis/relative.root";
    TFile* correctedGraphFile = new TFile(correctedGraphFileName.c_str(),"READ");

    string correctedGraphName = "relDiff124112_sd10_corrected_x100";
    TGraphErrors* correctedGraph = (TGraphErrors*)correctedGraphFile->Get(correctedGraphName.c_str());
    ...
    TLine *line1 = new TLine(1.88,3.45,212,3.45);
    line1->SetLineStyle(7);
    line1->SetLineWidth(2);
    line1->SetLineColor(kBlack);
    line1->Draw();

    TLine *line2 = new TLine(1.88,1.71,212,1.71);
