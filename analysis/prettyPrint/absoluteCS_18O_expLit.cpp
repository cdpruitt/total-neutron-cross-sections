void absoluteCS_18O_expLit()
{
    ...
    string expNatOGraphName = "O18";
    string litNatOGraphName = "18O(n,tot)";
    ...
    legend->AddEntry(expNatOGraph,"H_{2}^{18}O^{exp.} - H_{2}^{lit.} ","l");
    legend->AddEntry(litNatOGraph,"{}^{18}O^{lit.} (derived)","l");
