{
    ...
    string gammaTimeCorrectionName = "gammaOffsetH";
    ...
    // X-axis parameters
    gammaTimeCorrection->GetXaxis()->SetTitle("Time Offset of Macropulse");
    ...
    gammaTimeCorrection->GetXaxis()->SetRangeUser(-3,3);
