void absoluteCS_Sn_expLit()
{
    ...
    string expSnNatGraphName = "SnNat";
    ...
    TLegend *legend = new TLegend(0.2,0.2,0.4,0.45);
    //legend->SetHeader("data","C");
    legend->AddEntry(expSn112Graph,"{}^{112}Sn (exp.) ","l");
    legend->AddEntry(expSnNatGraph,"{}^{nat}Sn (exp.) ","l");
    legend->AddEntry(expSn124Graph,"{}^{124}Sn (exp.) ","l");
