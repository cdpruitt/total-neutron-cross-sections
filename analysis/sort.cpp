...
int main()
{
    ...
    while(!evtfile.eof())
    {
        ...
        totalOut << "event type = " << evtype << endl;
        ...
        totalOut << "channel type = " << channel << endl;
        ...
        if(evtype==1)
        {
            ...
            totalOut << "number of waveform samples = " << nSamp << endl;

            if(nSamp > 0)
                // We must be in MIXED mode; time to output wavelet.
            {
                totalOut << "MIXED event wavelet data";
                ...
                for(int i=0;i<nSamp;i++)
                {
                    ...
                    // format the wavelet samples in 10-sample rows
