...
\begin{figure*}
    ...
    \caption{(Color online) A typical TOF spectrum from the Ni/Rh
        ...
        flash, which arrived at $\approx$90 ns (not pictured).
    }
...
\begin{figure*}
    ...
    our data are shown in percent. From 3-100 MeV, we are fully consistent with the
    literature datasets but above 100 MeV, a difference is visible, peaking at
    $\approx$5\% at 300 MeV.
b}
...
\begin{figure*}
    \includegraphics[scale=0.35]{figures/relDiff_O18O16.png}
    \caption{(Color online) Neutron total cross sections for $^{58,64}$Ni.
...
\begin{figure*}
    \includegraphics[scale=0.35]{figures/relDiff_Ni64Ni58.png}
    \caption{(Color online) Neutron total cross sections for $^{58,64}$Ni.
     Panel one shows our measurement (in red) and literature data from
     Abfalterer (in % black).
     Panel two shows the relative difference between our 
...
\begin{figure*}
    \includegraphics[scale=0.35]{figures/relDiff_Sn124Sn112.png}
    \caption{(Color online) Neutron total cross sections for $^{58,64}$Ni.
     Panel one shows our measurement (in red) and literature data from
     Abfalterer (in % black).
     Panel two shows the relative difference between our 
