...
\cite{Mueller2010, AtkinsonPhDThesis, MahzoonPhDThesis}, we used an updated version of the DOM
...
\ref{ParameterValues} for all six isotopes. The purpose of this section is to
...
It should be noted that totally neglecting model discrepancy (common practice
in past optical model analyses) may dramatically bias the fitted parameters and
underestimate variances of extracted quantities \cite{Brynjarsdottir2014}.
...
DOM fit of \oSix\ to the experimental data used to constrain the potential.
The experimental proton \rxn\, neutron \el, \tot, 
...
comments on pseudo-data for reaction cross section; relative value of TCS, ECS,
and RCS data; importance of charge density distribution.
...
\begin{figure*}
    ...
    \caption{\oEight\ structural data used in DOM fit. Panel a shows the charge
        ...
        shown with associated one-$\sigma$ and two-$\sigma$ uncertainty bands.
        Panel b shows the DOM-calculated single-particle energies for protons
        and neutrons with a one-sigma error band (left side of each subpanel) and
        the known neutron and proton valence level energies, from \cite{AME2016}.
        Panels c and d show the DOM-calculated RMS charge radius and binding energy per
...
comments on o18 fit and missing experimental neutron data
