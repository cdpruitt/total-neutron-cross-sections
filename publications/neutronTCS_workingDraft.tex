...
These oscillations can be explained by a simple optical model (OM) picture as the result of a 
phase shift between 
...
(illustrated in figure \ref{OMPhaseShiftFigure}). This explanation was termed the ``nuclear 
...
spherical potential of radius $R$ and depth $U$, the phase shift $\delta$ is:
