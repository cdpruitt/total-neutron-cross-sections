...
\begin{table*}[ht]
    ...
    \begin{center}
        \begin{tabular}{ c c c c c c c }
            ...
            $^{103}$Rh & 100 & 99.9 & ?$\pm$? & ?$\pm$? & 2.8359 & [insert]\\
...
To verify our approach, we first benchmarked our \totEs results on natural samples
(both lengths of $^{\text{nat}}$C, $^{\text{nat}}$Ni, $^{\text{nat}}$Sn, and
$^{\text{nat}}$Pb) against the high-precision data sets on natural targets from Finlay
\cite{Finlay1993} and Abfalterer \cite{Abfalterer2001}, shown in figures
\ref{LiteratureBenchmarking}.
