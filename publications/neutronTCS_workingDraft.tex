...
\begin{abstract}
    ...
    \sigma_{Ni^{58}}}$), which are robust against systematic error,
    are presented, revealing additional information about
...
\begin{table*}[ht]
    \caption{Physical characteristics of all samples used for our \tots
        ...
        given. For calculating cross sections, the relevant ``sample thickness" is the areal
        density of nuclei $\rho_{\text{areal}}$, equivalent to
        the (volumetric) density times the length of the sample. For
        comparison, the Ni and Sn targets used in \cite{Abfalterer2001,
    ...
    \begin{center}
        \begin{tabular}{ c c c c c c c }
            ...
            H$_{2}$$^{\text{nat}}$O & 20.0(1) & 10.0(1) & 1.571 & 0.11103 & - &
            - \\
            D$_{2}$$^{\text{nat}}$O & 20.0(1) & 10.0(1) & 1.739 & 0.11103 & - &
            - \\
            H$_{2}$$^{18}$O & 20.0(1) & 10.0(1) & 1.738 & 0.11103 & 0.20 & 99\\

            $^{58}$Ni & 7.97(3) & 8.18(2) &
            3.6438 & 0.11965& 68.077 & 99.6 \\
            $^{\text{nat}}$Ni & 8.00(3) & 8.20(2) &
            3.6898 & 0.11917 & - & -\\
            $^{64}$Ni & 7.96(2) & 8.20(4) &
            3.9942 & 0.11918 & 0.926 & 92.2\\

            $^{103}$Rh & 2.03(1) & 10.20(2) & 2.8359 & 0.02426 & 100 & 99.9\\

            $^{112}$Sn & 13.65(3) & 8.245(5) &
            4.9720 & 0.083321 & 0.97 & 99.9\\
            $^{\text{nat}}$Sn & 13.68(3) & 8.245(5) &
            5.3263 & 0.084145 & - & -\\
            $^{124}$Sn & 13.73(3) & 8.245(5) &
            5.5492 & 0.083988 & 5.79 & 99.9\\
...
\begin{figure}
    \includegraphics[scale=0.24]{figures/TimingCorrectionStudy.png}
    \caption{(Color online) The $\gamma$-ray peak from the TOF spectrum for the
        blank sample is shown before and after each of our timing corrections.
        The offline software-CFD
        correction reduces the timing uncertainty of TOF-detector events from [insert
        value] to [insert value] and the $\gamma$-ray averaging correction
        reduces the uncertainty of the micropulse start time from [insert value]
        to [insert value]. The final $\gamma$-ray peak FWHM after both
        corrections is [insert value].
        }
...
resonance region (3-15 MeV). The RMS difference between our cross section
...
of event rate, depending on energy) was subtracted and spectra were mapped to the
energy domain.
...
\begin{figure*}
    ...
    \caption{(Color online) Neutron total cross sections for $^{58,64}$Ni.
        Panel a) shows our isotopic results (in shades of red) and
        corresponding literature data \cite{Perey1993, Dukarevich1967} (in
        shades of blue). Panel b) shows the relative difference between our data
