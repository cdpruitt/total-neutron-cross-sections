...
Each macropulse consists of \approx350 individual proton pulses, called
...
\snTwelveFour, and \pbEight\ are similar and key differences are noted. For
systematics of neutron skins and binding energies, see the companion letter
\cite{PruittPRL2020}.
...
forms. Radial dependences are defined a Woods-Saxon shape or a derivative:
...
determined by an integral over the imaginary part (see Eq. (3) of
...
\end{equation}
with the sign of $\mathbf{V_{2}}$ opposite that of $\mathbf{V_{1}}$.
...
\begin{table}[htbp]
    ...
    \input{parameters/ImVolumeParametersTable.tex}
    \caption{Imaginary parameters (volume-like, symmetric, nuclear-matter correction)}
    \input{parameters/ImVolumeNMCorrParametersTable.tex}
    \caption{Imaginary parameters (volume-like, asymmetric)}
    \input{parameters/ImVolumeAsymmParametersTable.tex}
\end{table}
\clearpage
\begin{table}[htbp!]
    \footnotesize
    \caption{Imaginary parameters (surface-like, symmetric)}
    \input{parameters/ImSurfaceParametersTable.tex}
    \vspace{0.3em}
    \caption{Imaginary parameters (surface-like, asymmetric)}
    \input{parameters/ImSurfaceAsymmParametersTable.tex}
    \vspace{0.3em}
    \caption{Spin-orbit parameters}
    \input{parameters/SpinOrbitParametersTable.tex}
\end{table}
