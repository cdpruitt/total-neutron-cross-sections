...
\ref{SixPanel} and our absolute \tot\ results for Rh are shown separately, in the 
supplemental materials. All previous
...
Except for the already well-measured \oSix, our measurement extends the known
energy range for the neutron \tot\ by a factor of several or more. In the case
of the rare isotopes \niFour\ and \snTwelve, only one datum at 14.1 MeV was 
available in the literature \cite{Dukarevich1967}; our new results on these
isotopes are in excellent agreement, within 2-3\%, of these data.

Relative differences of our measured \tot\ between $^{16,18}$O, $^{58,64}$Ni, and
$^{112,124}$Sn are shown in Fig. \ref{ThreePanelRelDiff}.
...
\begin{figure*}[tb]
    ...
    \caption[\oSixEight, \niEightFour, \snTwelveFour\ neutron \tot\ relative difference]
    {
        ...
        In the third panel, an additional gray dotted line shows the
        SAS model prediction but with an
        A$^{\frac{1}{6}}$ size scaling observed in Sn
        isotope shift data \cite{Anselment1986}).
        The blue band in each panel indicates
