...
void surfaceFG::load(double R0, double a0, double A0, double B0 ,
		     double C0,  double D0,  double m0, 
...

{
  ...
  FG.init(A,B,C,D,m,Wstart,Efermi);
...
//***************************************************************
  ...
  */
void surfaceFG::load(double strength, double R0, double a0)
{
  R = R0;
  a = a0;
...
void surfaceFG::SetEnergy(double Ecm0)
{
  Ecm = Ecm0;
  double V = FG.funct(Ecm);
 ...
 */
double surfaceFG::ImaginaryPot(double r)
{
...
//***************************************************************
  ...
  */
double surfaceFG::DispersiveCorrection(double r)
{
...
\param r is the radial distance in fm
   */
double surfaceFG::DerivativeDispersive(double r)
{
...
\param r is the radial distance in fm
   */
double surfaceFG::DerivativeParticleHole(double r)
{
...
//********************************************
   ...
   */
double surfaceFG::CentralImaginaryPotential(double Ecm)
{
  return FG.funct(Ecm);
}
//*******************************************
   ...
   * returns the magnitude of the dispersive correction
     \param Ecm in the center-of-mass energy in MeV
   */
double surfaceFG::CentralDeltaRealPotential(double Ecm)
{
  return FG.deltaV(Ecm);
}
//****************************************
  /**
...
double surfaceFG::CentralDerDeltaRealPotential(double Ecm)
{
  return FG.derDeltaV(Ecm);
}
